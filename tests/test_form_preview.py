"""
Unit tests for Form Preview feature
"""
import pytest
...
class TestJobStore:
    ...
    def test_create_job(self):
        ...
        job_id = self.store.create_job(job_data)
    ...
    def test_get_nonexistent_job(self):
        ...
        job = self.store.get_job("non-existent-id")
        assert job is None
    
    def test_update_job(self):
        """Test updating a job"""
        job_id = self.store.create_job({"test": "data"})
        
        # Update the job
        success = self.store.update_job(job_id, {"new_field": "value"})
    ...
    def test_update_nonexistent_job(self):
        ...
        success = self.store.update_job("non-existent-id", {"test": "data"})
    ...
    def test_delete_job(self):
        ...
        # Delete the job
        success = self.store.delete_job(job_id)
        assert success is True
    ...
    def test_delete_nonexistent_job(self):
        ...
        success = self.store.delete_job("non-existent-id")
        assert success is False
